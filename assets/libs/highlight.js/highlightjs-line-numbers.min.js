...
!(function(e, n) {
  ...
  function i(t) {
    'interactive' === n.readyState || 'complete' === n.readyState
      ? l(t)
  ...
  function f(e) {
    ...
    for (var t in n)
      if (n.hasOwnProperty(t)) {
        var r = n[t];
        p(r.textContent) > 0 &&
          (r.childNodes.length > 0 ? f(r) : h(r.parentNode));
      }
  }
  function h(e) {
    var n = e.className;
  ...
  var N = 'hljs-ln',
    ...
    x = /\r\n|\r|\n/g;
  e.hljs
    ? ((e.hljs.initLineNumbersOnLoad = i),
    ...
    document.addEventListener('copy', function(e) {
      ...
      if (t(n.anchorNode)) {
        var r;
        (dow.navigator.userAr =
          wingent.indexOf('Edge') !== -1 ? o(n) : n.toString()),
